...
namespace ReaderZ_LMS
{
    public partial class EBooks : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            FillData("select * from tbl_ebooks ORDER BY ID DESC");
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    FillData("select * from tbl_ebooks where EBook_Name = '" + txtSearch.Text + "' ORDER BY ID DESC");
                }
                else
                {
                    FillData("select * from tbl_ebooks where EBook_Name = '" + txtSearch.Text + "' and Language = '" + ddLangauge.Text + "' ORDER BY ID DESC");
                }
            }
        }
        ...
        protected void ddLangauge_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                FillData("select * from tbl_ebooks where Language = '" + ddLangauge.Text + "' ORDER BY ID DESC");
            }
        }
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            ...
            pos = pos + 1;
            ViewState["pos"] = pos;
            FillData("select * from tbl_ebooks");
        }
