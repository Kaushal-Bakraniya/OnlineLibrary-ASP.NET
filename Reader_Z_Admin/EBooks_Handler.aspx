<%@ Page Title="" Language="C#" MasterPageFile="~/Reader_Z_Admin/admin.Master" AutoEventWireup="true" CodeBehind="EBooks_Handler.aspx.cs" Inherits="ReaderZ_LMS.Reader_Z_Admin.EBooks_Handler" %>
                ...
                <div class="col-lg-8 fix-details">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-3">
                                    <h6 class="mt-3">PDF File</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    <asp:FileUpload ID="fileEBook" runat="server" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3">
