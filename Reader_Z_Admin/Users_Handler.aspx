<%@ Page Title="" Language="C#" MasterPageFile="~/Reader_Z_Admin/admin.Master" AutoEventWireup="true" CodeBehind="Users_Handler.aspx.cs" Inherits="ReaderZ_LMS.Reader_Z_Admin.Users_Handler" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <asp:FileUpload ID="fileProfilePic" runat="server" class="form-control" />
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9">
                                    <asp:Button ID="btnSubmit" class="btn btn-primary mt-3 mr-3" runat="server" Text="Add New User" OnClick="btnSubmit_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
